...
This README includes instructions for agents to use Curlmate for OAuth token management.
...
2. Exchange API key for JWT by calling:
...
4. Directly use the connection id with service format as x-connection header to get access token:
