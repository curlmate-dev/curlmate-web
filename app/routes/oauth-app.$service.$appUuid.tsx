...
export const loader = async({ params }: LoaderFunctionArgs) => {
    ...
    const app = await redis.get(`app:${appUuid}`);
...
export default function OauthAppPage() {
    ...
    return (
        <div className="bg-[#f5f5dc] text-[#222] font-mono">
            <div className="max-w-3xl mx-auto py-10">
                
                <div className="bg-white border border-gray-400 rounded p-4 mb-6">
                <h2 className="text-lg font-bold mb-2">OAuth App</h2>
                ...
                <div className="border border-gray-400 bg-white text-gray-600 p-4 w-full max-w-2xl shadow-md space-y-4">
                    ...
                    <div className="bg-gray-100 text-blue-600 p-2 text-xs break-all"><a href={loaderData.app.authUrl} target="_blank">{loaderData.app.authUrl}</a></div>
                    </div>
                </div>
